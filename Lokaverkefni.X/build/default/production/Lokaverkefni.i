...
# 13 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic.h" 3
...
int KeyPad(void)
{
    ...
    if(input == 0x11 || input == 0x21 || input == 0x41 || input == 0x81){
        switch(input){
            case 0x11: tala = 1; press++; break;
            case 0x21: tala = 4; press++; break;
            case 0x41: tala = 7; press++; break;
            case 0x81: tala = 14; press++; break;
        }
    }
    _delay((unsigned long)((5)*(8000000/4000.0)));
    PORTD = 0x02;
    ...
    if(input == 0x12 || input == 0x22 || input == 0x42 || input == 0x82){
        switch(input){
            case 0x12: tala = 2; press++; break;
            case 0x22: tala = 5; press++; break;
            case 0x42: tala = 8; press++; break;
            case 0x82: tala = 0; press++; break;
        }
    }
    _delay((unsigned long)((5)*(8000000/4000.0)));
    PORTD = 0x04;
    ...
    if(input == 0x14 || input == 0x24 || input == 0x44 || input == 0x84){
        switch(input){
            case 0x14: tala = 3; press++; break;
            case 0x24: tala = 6; press++; break;
            case 0x44: tala = 9; press++; break;
            case 0x84: tala = 15; press++; break;
        }
    }
    _delay((unsigned long)((5)*(8000000/4000.0)));
    PORTD = 0x08;
    ...
    if(input == 0x18 || input == 0x28 || input == 0x48 || input == 0x88){
        switch(input){
            case 0x18: tala = 10; press++; break;
            case 0x28: tala = 11; press++; break;
            case 0x48: tala = 12; press++; break;
            case 0x88: tala = 13; press++; break;
        }
    }
    _delay((unsigned long)((5)*(8000000/4000.0)));
    if((press == 0) && (tala == -1)){
        ...
        if(num == 0){
            ...
            do{
                ...
                if (RB6 == 1) {
                    ...
                    flicker1++;
                    flickerA1++;
                    if (DebounceA == 0 && flicker1 >= flickerspeed) {
                        DebounceA = 1;
                        segull++;
                        flicker1 = 0;
                        flickerA1 = 0;
                ...
                if (RB7 == 1) {
                    ...
                    flicker2++;
                    flickerA2++;
                    if (DebounceB == 0 && flicker2 >= flickerspeed) {
                        DebounceB = 1;
                        segull++;
                        flicker2 = 0;
                        flickerA2 = 0;
...
void main()
{
 ...
 ANSEL = 0x00;
 ANSELH = 0x00;
 CM1CON0 = CM1CON0 & 0x7F;
 CM2CON0 = CM2CON0 & 0x7F;
 INTCON = 0x00;
